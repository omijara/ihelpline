              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <tr>
                    ...
                    <a href="edit.php?id=<?php echo $rows["id"]?>"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="mdi mdi-square-edit-outline"></i>
                    </button>
